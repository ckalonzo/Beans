...
import ContractorProfile from "./Pages/Profile/Layout/ContractorProfile";
    ...
    return (
      <Router>
        <div className="App">
          <Navbar />
          <Switch>
            <Route path="/Profile/Review/Review" component={Review} />
            <Route
              path="/Profile/Layout/ContractorProfile"
