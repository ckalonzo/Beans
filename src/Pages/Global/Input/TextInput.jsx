...
export class TextInput extends Component {
      ...
      componentDidMount() {
            if (!this.props.disableError && this.props.errorOnUsage) {
      ...
      onValidate(event) {
            ...
            } else if (event.target.value.length < (this.props.minLength || DEFAULT_MIN_CHARS)) {
                  this.setOrDisableError(true, "Length must be greater than" + (this.props.minLength || DEFAULT_MIN_CHARS));
            } else {
                  this.setOrDisableError(false);
            }
                  ...
                  return (
                        <div>
                              <textarea
                                    ...
                                    value={this.props.value}
                                    maxLength={this.props.maxLength ? this.props.maxLength : DEFAULT_MAX_CHARS}
                                    minLength={this.props.minLength ? this.props.minLength : DEFAULT_MIN_CHARS}
                              />
                        </div>
                  );
