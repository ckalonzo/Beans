                  ...
                  <div className="form-row -ta_mt-30">
                    <div className="col">
                      ...
                      <TextInput
                        ...
                        value={this.props.contractorProfile.firstName}
                      />
                    </div>
                    <div className="col">
                      <TextInput
                        ...
                        onBlur={this.onBlur}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.lastName}
                      />
                    </div>
                  </div>
                  <div className="form-row -ta_mt-10">
                    <div className="col">
                      <TextInput
                        ...
                        onBlur={this.onBlur}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.email}
                      />
                    </div>
                    <div className="col">
                      <TextInput
                        ...
                        onBlur={this.onBlur}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.phone}
                      />
                    </div>
                  </div>
                  <div className="form-row -ta_mt-10">
                    <div className="col">
                      <TextInput
                        ...
                        onBlur={this.onBlur}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.password}
                      />
                    </div>
                    <div className="col">
                      <TextInput
                        ...
                        onBlur={this.onBlur}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.confirmPassword}
                      />
                    </div>
                  </div>
                  <div className="form-row">
                    <div className="col">
                      <TextInput
                        ...
                        onBlur={this.onBlur}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.address1}
                      />
                    </div>
                  </div>
                  <div className="form-row">
                    <div className="col">
                      <TextInput
                        ...
                        onBlur={this.onBlur}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.address2}
                      />
                    </div>
                  </div>
                  <div className="form-row -ta_mt-10">
                    <div className="col">
                      <TextInput
                        ...
                        onBlur={this.onBlur}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.city}
                      />
                    </div>
                    <div className="col">
                      <select
                        ...
                        tabIndex={"10"}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.state}
                      >
                  ...
                  <div className="form-row -ta_mt-10">
                    <div className="col">
                      <TextInput
                        ...
                        onBlur={this.onBlur}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.zip}
                      />
                    </div>
                    <div className="col">
                      <select
                        ...
                        tabIndex={"12"}
                        onChange={this.onChange}
                        value={this.props.contractorProfile.country}
                      >
