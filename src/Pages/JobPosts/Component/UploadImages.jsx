...
//constants
const UPLOAD_HEADER_TEXT =
  " Uploading Images is optional but highly recommended to help providers recieve more accruate bids";
const UPLOAD_SUBHEADER_TEXT =
  "\nThe Images must be in a file format of a .jpeg or .png and the size should be " +
  "300px X 300px.";
...
class UploadImages extends Component {
  ...
  renderImage(resizedImageUrl, remotePhotoData) {
    ...
    return <img src={image} alt="customer-files" className="logo-preview" />;
  }
  errorMessage() {
    if (this.state.error) {
      return (
