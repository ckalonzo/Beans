...
const data = [
  {
    ...
    additionalInformation:
      " Line 28:  The href attribute requires a valid value to be acce Line 28:  The href attribute requires a valid value to be acce",
    Budget: "60.00"
  },
  {
    typeOfJob: "Junk Removal",
              ...
              renderItem={item => (
                <List.Item>
                  <List.Item.Meta
                    ...
                    title={
                      <Link href="https://ant.design">{item.typeOfJob}</Link>
                    }
