      ...
      <div className="container">
        <div className="row">
          <div className="col-md-3 col-lg-3 col-sm-3">
            <label>
              <input
                type="radio"
                defaultvalue={values.typeOfTruck}
                id={typeOfTruck}
                checked={typeOfTruck === "RegularTruck"}
                value="RegularTruck"
                onChange={handleChange("typeOfTruck")}
                className="card-input-element checkmark "
              />
              <div className="card ">
                <img
          ...
          <div className="col-md-3 col-lg-3 col-sm-3">
            <label>
              <input
                type="radio"
                id={typeOfTruck}
                checked={typeOfTruck === "SmallTruck"}
                value="SmallTruck"
                onChange={handleChange("typeOfTruck")}
                className="card-input-element checkmark"
              />
              ...
              <div className="card ">
                <img
                  className="card-img-top"
                  src="https://imgur.com/E9odOLx.png"
                  alt="Mid Truck"
                ></img>
                <div className="card-body">
          ...
          <div className="col-md-3 col-lg-3 col-sm-3">
            <label>
              <input
                type="radio"
                id={typeOfTruck}
                checked={typeOfTruck === "LargeTruck"}
                value="LargeTruck"
                onChange={handleChange("typeOfTruck")}
                className="card-input-element checkmark"
              />
          ...
          <div className="col-md-3 col-lg-3 col-sm-3">
            <label>
              <input
                type="radio"
                id={typeOfTruck}
                checked={typeOfTruck === "extraLargeTruck"}
                value="extra Large"
                onChange={handleChange("typeOfTruck")}
                className="card-input-element checkmark"
              />
              ...
              <div className="card ">
                <img
                  className="card-img-top"
                  src="https://imgur.com/nGB1nCt.png"
                  alt="Extra Large Truck"
                ></img>
                <div className="card-body">
        ...
        {/* <div className="row cc-selector">
            <div className="col-sm">
              ...
              />
              <label
                className="drinkcard-cc pickuptruck"
                for="pickuptruck"
              ></label>
            </div>
            <div className="col-sm">
              ...
              />
              <label
                className="drinkcard-cc smallTruck"
                for="smallTruck"
              ></label>
            </div>
            <div className="col-sm">
            ...
            <div className="col-sm">
              ...
              />
              <label
                className="drinkcard-cc largeTruck"
                for="largeTruck"
              ></label>
            </div>
          </div>
